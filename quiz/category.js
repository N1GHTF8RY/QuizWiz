document.addEventListener("DOMContentLoaded", function () {
    const itemList = [
        { text: "general knowledge", imageUrl: "category/sports.png" },
        { text: "books", imageUrl: "category/history.png" },
        { text: "films", imageUrl: "category/music.png" },
        { text: "music", imageUrl: "category/agriculture.png" },
        { text: "television", imageUrl: "category/sports.png"},
        { text: "video games", imageUrl: "category/science.png" },
        { text: "board games", imageUrl: "category/sports.png"},
        { text: "science and nature", imageUrl: "category/science.png" }
    ];
